...
def load_hamer(checkpoint_path=DEFAULT_CHECKPOINT, device="cuda:0"):
    ...
    model = HAMER.load_from_checkpoint(checkpoint_path, strict=False, map_location=map_location, cfg=model_cfg)
