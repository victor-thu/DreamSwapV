...
We also recommend installing flash-attn-3 for faster inference. We have provided a precompiled wheel built in our test environment, which you can install using the following command:
```
...
You can download DreamSwapV ckpt from (https://huggingface.co/) to any folder and pass it through args.checkpoint.
...
### 🎉 Credits
Licenses for borrowed code can be found in [licenses.md](https://code.byted.org/wangweitao.owl/DreamSwapV/edit/main-patch-1-patch-1/licenses.md) file. 
...
### License
The project is licensed under the [Apache2.0 license](https://code.byted.org/wangweitao.owl/DreamSwapV/edit/main-patch-1-patch-1/license.txt). To utilize or further develop this project for commercial purposes through proprietary means, permission must be granted by us (as well as the owners of any borrowed code).
